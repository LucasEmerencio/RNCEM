...
model_name = "vgg16"
weights_path = "/home/lucas/TCC/Classificadora/vgg16_aug_pt.pth" #SUBSTITUIR PELO SEU CAMINHO DE PESOS
quiet_mode = True
...
def detect_and_crop(path):
  ...
  os.chdir('/home/lucas/TCC/Detectora/darknet') #SUBSTITUIR PELO SEU CAMINHO DA DARKNET
